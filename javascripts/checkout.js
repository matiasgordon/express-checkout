...
(function () {
    ...
    this.Checkout.token = function () {
        ...
        token.post = function(dataObj, callback){
            ...
            var _method = (Checkout.tokenId == null) ? "POST":"PUT",url=token.cardTokenUrl,_body;
            ...
            url+="callback=?&_method="+_method+"&public_key="+Checkout.key + "&js_version="+Checkout.version;
           jQuery.ajax({
                url:url,
                dataType:"jsonp",
                timeout : 10000,
                error : function(jqXHR, textStatus, errorThrown) { 
                    ...
                    Checkout.trackErrors({status:jqXHR.status, type:"cardForm", data:jQuery.parseJSON(jqXHR.responseText)});
                    
                    typeof callback == "function" ?  callback(jqXHR.status , {status:jqXHR.status, error: textStatus, cause:[]}) : null;
                },
                success:function(response){
                   typeof callback == "function" ?  callback(response[0] , response[2]) : null;
                }
            });
        };
    ...
    this.Checkout.paymentMethods = (function(_super) {
        ...
        paymentMethods.getAllPaymentMethods = function(callback){
            ...
            var _success = function(data){
                paymentMethods.setPaymentMethods(data);
                typeof callback == "function" ?  callback(200, data) : null;
            };
            if (window.XDomainRequest) {
                var xdr = new XDomainRequest();
                xdr.open("get", url);
                ...
                xdr.ontimeout = function(){};
                xdr.onerror = function () {
                    Checkout.trackErrors({status:"error", type:"getAllPaymentMethods", data:{user_agent:window.navigator.userAgent}});
                    typeof callback == "function" ?  callback(404, {status:404, error : "not_found", cause:[]}) : null;
                };
                setTimeout(function(){
                    xdr.send();
                    }, 0);
                ...
                jQuery.ajax({
                    ...
                    timeout : 10000,
                    error : function(jqXHR, textStatus, errorThrown) { 
                        Checkout.trackErrors({status:jqXHR.status, type:"getAllPaymentMethods", data:jQuery.parseJSON(jqXHR.responseText)});
                        typeof callback == "function" ?  callback(jqXHR.status, jQuery.parseJSON(jqXHR.responseText)) : null;
                    },
        ...
        paymentMethods.searchPaymentMethods = function(id,amount,callback,pmethod){
            ...
            var _success = function(data){
                    ...
                    typeof callback == "function" ?  callback(200, data, {id:id, amount:amount}) : null;
            };
            if (window.XDomainRequest) {
                var xdr = new XDomainRequest();
                xdr.open("get", url);
                ...
                xdr.ontimeout = function(){};
                xdr.onerror = function () {
                    Checkout.trackErrors({status:"error", type:"searchPaymentMethods", data:{user_agent:window.navigator.userAgent}});
                    typeof callback == "function" ?  callback(404, {status:404, error : "not_found", cause:[]}, {id:id, amount:amount}) : null;
                };
                setTimeout(function(){
                    xdr.send();
                    }, 0);
                ...
                jQuery.ajax({
                    ...
                    timeout : 10000,
                    error : function(jqXHR, textStatus, errorThrown) { 
                        Checkout.trackErrors({status:jqXHR.status, type:"searchPaymentMethods", data:jQuery.parseJSON(jqXHR.responseText)});
                        typeof callback == "function" ?  callback(jqXHR.status, jQuery.parseJSON(jqXHR.responseText), {id:id, amount:amount}) : null;
                    },
                    success: function(data) {
                        _success(data);
                    }
        ...
        paymentMethods.getAcceptedCardIssuers = function(callback){
            ...
            var _success = function(response){
                ...
                typeof callback == "function" ?  callback(200, response) : null;
            };
            if (window.XDomainRequest) {
                var xdr = new XDomainRequest();
                xdr.open("get", url);
                ...
                xdr.ontimeout = function(){};
                xdr.onerror = function () {
                    Checkout.trackErrors({status:"error", type:"cardIssuers", data:{user_agent:window.navigator.userAgent}});
                    typeof callback == "function" ?  callback(404, {status:404, error : "not_found", cause:[]}) : null;
                };
                setTimeout(function(){
                    xdr.send();
                ...
                jQuery.ajax({
                    ...
                    timeout : 10000,
                    error : function(jqXHR, textStatus, errorThrown) { 
                        Checkout.trackErrors({status:jqXHR.status, type:"cardIssuers", data:jQuery.parseJSON(jqXHR.responseText)});
                        typeof callback == "function" ?  callback(jqXHR.status, jQuery.parseJSON(jqXHR.responseText)) : null;
                    },
                    success: function(data) {
                        _success(data);
        ...
        paymentMethods.getFullCardIssuers = function(siteId,callback){
            ...
            var _success = function(response){
                ...
                typeof callback == "function" ?  callback(200, response.results) : null;
            };
            if (window.XDomainRequest) {
                var xdr = new XDomainRequest();
                xdr.open("get", url);
                ...
                xdr.ontimeout = function(){};
                xdr.onerror = function () {
                    Checkout.trackErrors({status:"error", type:"cardIssuersSearch", data:{user_agent:window.navigator.userAgent}});
                    typeof callback == "function" ?  callback(404, {status:404, error : "not_found", cause:[]}) : null;
                };
                setTimeout(function(){
                    xdr.send();
                ...
                jQuery.ajax({
                    ...
                    timeout : 10000,
                    error : function(jqXHR, textStatus, errorThrown) { 
                        Checkout.trackErrors({status:jqXHR.status, type:"cardIssuersSearch", data:jQuery.parseJSON(jqXHR.responseText)});
                        typeof callback == "function" ?  callback(jqXHR.status, jQuery.parseJSON(jqXHR.responseText)) : null;
                    },
                    success: function(data) {
                        _success(data);
